...
const ChatScreen = () => {
  ...
  const setupSocket = () => {
    ...
    newSocket.on("connect", () => {
      M.toast({
        html: `🌐 <span style="color:black">User Mode Online!</span>`,
        classes: "#12b697 teal accent-3",
      });
    ...
    newSocket.on("disconnect", () => {
      M.toast({
        html: `❗ <span style="color:black" > User Mode Offline!</span>`,
        classes: "#a91409 red",
      });
    ...
    newSocket.on("online users", (data) => {
      ...
      let onlineUsersList = [];
      if (data.users)
        onlineUsersList = data.users.filter((user) => user._id !== myId);
  ...
  const newMessage = (message) => {
    if (!message) {
      M.toast({
        html: `⚠️<span style="color:black" >Message can't be empty!!!</span>`,
        classes: "yellow red",
      });
      return;
    }
        ...
        <div className="main__chatbody">
          ...
          <ChatContent
            ...
            chats={
              chatWithUserId
                ? [
                    ...chatState.chatData.filter(
                      (item) => item.email === chatWithUserId.email
                    ),
                  ]
                : []
            }
            ...
            <div className="main__userprofile">
              <div className="profile__card user__profile__image">
                ...
                >
                  ...
                  >
                    <h5 style={{ color: "blue" }}>{chatWithUserId.name}</h5>
