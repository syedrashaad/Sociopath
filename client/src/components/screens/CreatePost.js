...
const CreatePost = () =>{
    ...
    const postDetails = () => {
        if (!title) {
          M.toast({
            html: `⚠️<span style="color:black" > Please provide suitable title</span>`,
        ...
        if (!body) {
          M.toast({
            html: `⚠️<span style="color:black" > Please provide suitable description</span>`,
            classes: "yellow red accent-2"
          });
          return;
        }
        ...
        if (!image) {
          M.toast({
            html: `⚠️<span style="color:black" > Please provide suitable image</span>`,
            classes: "yellow red accent-2"
          });
          return;
        }
